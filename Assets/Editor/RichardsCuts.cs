...
public class RichardsCuts : MonoBehaviour {
	[MenuItem("RichardsCuts/Anchors to Corners %[")]
	...
	[MenuItem("RichardsCuts/Corners to Anchors %]")]
	...
	[MenuItem("RichardsCuts/ToggleActive %`")]
