...
requiredCustomFrameworks = ['AdjustSdk', 'AdColony', 'AdColonyAdapter', 'Chartboost', 'CHAMoatMobileAppKit', 'FacebookAdapter', 'FBAudienceNetwork', 'FirebaseCore', 'FirebaseCoreDiagnostics', 'FirebaseInstanceID', 'FirebaseAnalytics', 'FirebaseDynamicLinks', 'GoogleToolboxForMac', 'FirebaseNanoPB', 'GoogleMobileAds', 'MoPubAdapter', 'MPUBMoatMobileAppKit', 'nanopb', 'UnityAdapter', 'UnityAds', 'VungleAdapter', 'VungleSDK']
