        ...
        private void AddDataToHelper(List<SpilCurrencyData> currencies, List<SpilItemData> items, List<SpilBundleData> bundles, List<SpilShopTabData> shop) {
            ...
            if (items != null) {
                foreach (SpilItemData spilItemsData in items) {
                    Items.Add(new Item(spilItemsData.id, spilItemsData.name, spilItemsData.type, spilItemsData.imageUrl, spilItemsData.reportingName, spilItemsData.displayName, spilItemsData.displayDescription, spilItemsData.isGacha, spilItemsData.content, spilItemsData.properties, spilItemsData.limit, spilItemsData.isUnique));
                }
            }
